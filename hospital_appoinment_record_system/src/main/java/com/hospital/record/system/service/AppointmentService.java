...
public class AppointmentService {
	...
	public ResponseEntity<ResponseStructure<List<Appointment>>> fetchAppointmentByDoctorId(
	...
	public ResponseEntity<ResponseStructure<List<Appointment>>> fetchAppointmentByPatientId(
